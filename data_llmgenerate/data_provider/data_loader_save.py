...
class Dataset_G60(Dataset):
    def __init__(self, root_path="data/", flag='train', size=None,
                 features='M', data_path='G60',
                 target='all', scale=False, inverse=False, timeenc=0, freq='t'):
        if size == None:
            self.seq_len = 24 * 12
...
class Dataset_G56(Dataset):
    def __init__(self, root_path="data/", flag='train', size=None,
                 features='M', data_path='G56',
                 target='all', scale=False, inverse=False, timeenc=0, freq='t'):
        if size == None:
            self.seq_len = 24 * 6
            self.label_len = 24 * 6
